...
class PlaywrightScraperAdapter:
    ...
    def fetch_products(self) -> list[RawProduct]:
        ...
        if not is_headless:
            # Place window far offscreen so it runs completely in the background without user interruption
            ...
            with sync_playwright() as p:
                ...
                try:
                    context = browser.new_context(
                        ...
                        locale="en-US",
                        user_agent=active_config.user_agent if active_config.user_agent else None,
                        extra_http_headers={
        ...
        try:
            ...
            if _STEALTH:
                try:
                    ...
                    logger.debug("Stealth injection note: %s", stealth_err)
